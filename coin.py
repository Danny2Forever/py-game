...
class Coin(pygame.sprite.Sprite):
    def __init__(self, max_x, max_y):
        ...
        coin0 = pygame.image.load('game/assets/Coin/Gold/coin0.png')
        coin1 = pygame.image.load('game/assets/Coin/Gold/coin1.png')
        coin2 = pygame.image.load('game/assets/Coin/Gold/coin2.png')
        coin3 = pygame.image.load('game/assets/Coin/Gold/coin3.png')
