...
class Enemy(pygame.sprite.Sprite):
    def __init__(self, max_x, max_y):
        ...
        enemy0 = pygame.image.load('game/assets/Enemy/Octopus/enemy0.png')
        enemy1 = pygame.image.load('game/assets/Enemy/Octopus/enemy1.png')
        enemy2 = pygame.image.load('game/assets/Enemy/Octopus/enemy2.png')
        enemy3 = pygame.image.load('game/assets/Enemy/Octopus/enemy3.png')
